...
const qnaList = [
  ...
  {
    q: '3. 친구의 생일선물을 줄 때 나의 기준은?',
    a: [
      { answer: 'a. 친구의 위시리스트를 반영한다.', type: [0] },
      { answer: 'b. 고심해서 친구에게 잘 어울릴 걸 고른다.', type: [3] },
  ...
  },
  {
    ...
    a: [
      ...
      { answer: 'c. 속으로는 싫은데 마지못해 수락한다. "(싫은데…) 좋아 ^-^;" ', type: [3] },
    ]
  },
  {
  ...
  },
  {
    q: '9. 음식 메뉴를 정할 때 나는?',
    a: [
      { answer: 'a. 친구가 정한 곳으로 따라간다.', type: [1] },
      { answer: 'b. 인스타로 맛집 검색해서 찾아간다.', type: [4] },
      { answer: 'c. 내가 먹고싶은 곳으로 친구를 데려간다.', type: [3] },
    ]
  }
]
